public class ChosenOption {
     ...
     * @param system1 NOT NEEDED-- DELETE LATER
     * @param admininputgetter NOT NEEDED-- DELETE LATER
    ...
    public Object executeOption(User user, ItemManager allItems, InputGetter system1, TradeRequestManager allTradeRequests,
        ...
        return ((userMainMenuOptions) chosenOption).execute(user, allItems, system1, allTradeRequests, allUsers, allMeetings, allTransactions,
